...
export const Projects: ProjectInterface[] = [
  {
    ...
    shortDescription:
      "Developed and optimized to make someone's tasks easy",
    websiteLink: "https://github.com/htnahddis/TaskManager",
    techStack: [
      "Next.js",
      "React",
      "Node.js",
    ...
    companyLogoImg: "/projects/builtdesign/imageforproject.png",
    pagesInfoArr: [
      {
        title: "Landing Page",
        description:
